const debug = require('debug')('bleno:smp');
...
class Smp extends EventEmitter {
  constructor(aclStream, localAddressType, localAddress, remoteAddressType, remoteAddress, blenoOptions) {
    super();
    ...
    this._mgmt = new Mgmt(blenoOptions)
  }
